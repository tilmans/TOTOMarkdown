...
// TOTOMarkdown
#define COCOAPODS_POD_AVAILABLE_TOTOMarkdown
#define COCOAPODS_VERSION_MAJOR_TOTOMarkdown 0
#define COCOAPODS_VERSION_MINOR_TOTOMarkdown 1
#define COCOAPODS_VERSION_PATCH_TOTOMarkdown 0
